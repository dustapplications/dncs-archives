    ...
    <div class="container">
        <nav aria-label="breadcrumb" class="mt-3">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('po-office-process',[request()->route('office')]) }}">{{ $office }}</a></li>
                <li class="breadcrumb-item"><a href="{{ route('po-office-root-process',[request()->route('office'),request()->route('process')]) }}">{{ $process->process_name }}</a></li>
                ...
                @else
                    <li class="breadcrumb-item">
                        <a href="{{ route('po-office-parent-process',[request()->route('office'),request()->route('process'),$key]) }}">{{ $file }}</a>
                    </li>
                @endif
                @endforeach
            </ol>
        ...
        <div class="row g-3">
            ...
            @foreach ($folders as $folder)
                <div class="col-2">
                    <a class="folder btn d-flex align-items-center justify-content-center" href="{{ route('po-office-parent-process',[request()->route('office'),request()->route('process'),$folder->id]) }}">
                        {{ $folder['folder_name'] }}
                    </a>
                </div>
            @endforeach
                    ...
                    <div class="dropdown">
                        <button class="file btn d-flex align-items-center justify-content-center" data-bs-toggle="dropdown" aria-expanded="false">
                            <div>
                                ...
                                <span class="text-dark">{{ $file['directory']['filename'] }}.{{ $file['directory']['extension'] }}</span>
                            </div>
                        </button>
